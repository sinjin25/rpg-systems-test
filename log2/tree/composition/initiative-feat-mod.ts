...
const initiativeFeatMod = (owner: OwnerMaximal) =>
    newModNode(displayName, collectFeatContributions(owner, 'initiative-feat-mod'), sumFunc)

export default initiativeFeatMod
