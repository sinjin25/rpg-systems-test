...
export type BroadContexts = 'save' | 'attack' | 'skill'
    | 'damage' | 'damageTaken' // damage -> damageTaken
    | 'heal' | 'health'
    | 'stat' | 'initiative' | 'ac' | 'maxDex' | 'critRange' | 'critMultiplier' | 'dc'
export type BasicContexts = 'melee' | 'ranged' | 'magic' | 'finesse' | 'constitution' | 'dexterity' | 'natural'
export type EquipmentContextNames = 'dagger' | 'shortsword' | 'bow' | 'longsword' | 'shield' | 'lightArmor' | 'heavyArmor'
